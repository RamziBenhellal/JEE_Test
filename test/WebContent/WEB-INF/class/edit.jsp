	...
	<div class="container ">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-3">
				...
				<form action="/test/class/edit" method="post">
					<h3 class="col-md-offset-3">Create New Class</h3>
					<div class="form-group ">
						<label for="classcode">Class Code : </label> <input type="text" value="${c.classCode }"
							class="form-control" id="classcode" name="classcode"
							placeholder="Class Code  ">
					</div>

					<div class="form-group">
						<label for="studentsnumber">Students Number : </label> <input type="text"
							class="form-control" id="studentsnumber" name="studentsnumber" value="${c.studentsNumber }"
					...
					<div class="form-group">
						<label for="specialty">Speciality : </label> <select
							...
							<option value="${c.specialty }">${c.specialty }</option>
