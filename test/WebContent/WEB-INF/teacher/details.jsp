			...
			<c:when test="${ empty error }">
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-1">
						<h2 class="col-md-offset-3">Teacher Informations</h2>
						<dl class="row">
							...
							<dd class="col-sm-9">${ teacher.module }</dd>

							<dt class="col-sm-3">Speciality :</dt>
							<dd class="col-sm-9">${ teacher.tClass }</dd>
						</dl>

						<ul class="list-inline">
							<li class="list-inline-item"><a class="btn btn-primary"
								href="/test/teacher/edit?id=${ teacher.codeTeacher }"
								role="button"><span class="glyphicon glyphicon-edit"></span>&nbsp;Edit</a></li>
							<li class="list-inline-item">
								<form
									action="/test/teacher/details?id=${ teacher.codeTeacher }"
									method="post">
